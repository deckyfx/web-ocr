...
public static class PortalRoutes
{
    public static void MapPortalRoutes(this WebApplication app)
    {
        ...
        // ── TextSeg debug overlay ─────────────────────────────────────────────
        // Returns an array of {x,y,w,h} boxes representing the text regions
        // detected by comictextdetector.  If the boxes were cached by a previous
        // translation run they are returned immediately; otherwise TextSeg runs
        // on the job's original.png and the result is cached for next time.
            ...
            InferenceQueue       queue) =>
        {
            ...
            // Fast path: blocks already computed during translation.
            ...
            // Slow path: run TextSeg on demand.
        ...
        // Delete a single TextSeg block by index (removes from cached JSON).
